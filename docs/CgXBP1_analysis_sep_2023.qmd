...
ComplexHeatmap::Heatmap(data_for_tca_heatmap_wt, cluster_columns = F, show_row_dend = F, name = "Z-score", cluster_rows = F)
...
ComplexHeatmap::Heatmap(data_for_tca_heatmap_xbp1, cluster_columns = F, show_row_dend = F, name = "Z-score", cluster_rows = F)
...
ComplexHeatmap::Heatmap(data_for_aa_heatmap_wt, cluster_columns = F, show_row_dend = F, name = "Z-score", cluster_rows = F)
...
ComplexHeatmap::Heatmap(data_for_aa_heatmap_xbp1, cluster_columns = F, show_row_dend = F, name = "Z-score", cluster_rows = F)
